...
[chara_face name="meds" face="clasedmouth" storage="chara/meds/closedmouth.png"]
...
/*
選択肢（ルート変化なし
text1="いえ、大丈夫です！" text2="散歩してただけなので！"
ルート変化があるかもと思って周回してしまう可能性があるため、一旦一択にしておきます。
選択肢の色とかで変化するか分かるとよさそう
*/

[sb1 text="いえ、大丈夫です！" next="continue2"]
[s]
*continue2
@dsb
...
/*
選択肢（ルート変化なし
text1="何ともないです" text2="おかげさまで完治しました"
ルート変化があるかもと思って周回してしまう可能性があるため、一旦一択にしておきます。
選択肢の色とかで変化するか分かるとよさそう
*/

[sb1 text="何ともないです" next="continue4"]
[s]
*continue4
@dsb
...
/*
選択肢（ルート変化なし
text1="限界まで睡眠を！？" text2="ここには睡眠の研究所があったはずじゃ……"
ルート変化があるかもと思って周回してしまう可能性があるため、一旦一択にしておきます。
選択肢の色とかで変化するか分かるとよさそう
*/
[sb1 text="限界まで睡眠を！？" next="continue5"]
[s]
*continue5
@dsb
