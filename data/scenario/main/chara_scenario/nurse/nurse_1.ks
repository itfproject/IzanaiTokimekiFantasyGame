...
@serifu
#nurse:sad
申し訳ありません、怖がらせてしまいましたかね……。[l]私は看護学類です。[l]怖がらないで大丈夫ですよ。[p]
...
@serifu
[m_name]
これから授業なんです！[l] 2C棟に行こうとしてて……あそこの建物で合ってますか？[p]
...
@serifu
[m_name]
ありがとうございます！[l]　ごめんなさい、もう少しで授業なので失礼します！[p]
...
[l]
[eval exp="sf.scenario_progress[6][1] = 1;"]
;仮メニューに帰る
@jump storage="main/chara_scenario/nurse/nurse_2.ks"
